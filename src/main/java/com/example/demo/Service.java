...
public class Service {
  ...
  //@GetMapping("/user")
  @RequestMapping(value="/user",method = RequestMethod.GET)//by default get mapping can use for all mapping
  public String fun4(@RequestParam("email") String email) {//Request param means we use question mark
  ...
  public User fun9 (@RequestBody User user) {
	  ...
	  if(user2==null) {
		  ...
		  System.out.println("paswords match!");
		  return user2;
	  }
	  else {
